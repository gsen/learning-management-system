...
import { useEnrollInCourseMutation, useFetchUserEnrollmentsQuery } from "@/store/services/enrollment-service";
...
export default function CourseDetailsPage() {
  ...
  const currentEnrollment = enrollments.find((enrollment) => getCourseId(enrollment.course) === id);
  ...
  async function handleEnroll() {
    ...
    try {
      ...
      toast.error(getApiErrorMessage(enrollError, "Unable to enroll in this course."), { position: "bottom-center" });
    }
  }
  ...
  if (error) {
    return <p className="text-sm text-destructive">{getApiErrorMessage(error, "Unable to fetch course.")}</p>;
  }
