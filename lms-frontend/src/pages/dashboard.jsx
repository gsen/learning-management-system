  ...
  return (
    <div className="grid gap-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Track enrolled courses and progress percentages.</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Pick up from your latest enrollments.</CardDescription>
          <CardAction>
            <Link to="/my-courses" className="text-sm underline underline-offset-4">
              View all
            </Link>
          </CardAction>
        </CardHeader>
        <CardContent className="grid gap-3">
          {recentEnrollments.length === 0 ? (
            ...
            recentEnrollments.map((enrollment) => {
              ...
              return (
                <div key={enrollment._id} className="grid gap-3 rounded-2xl border p-3 md:grid-cols-[1fr_auto]">
