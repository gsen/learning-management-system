...
export default function MyCoursesPage() {
  ...
  if (error) {
    return <p className="text-sm text-destructive">{getApiErrorMessage(error, "Unable to fetch your courses.")}</p>;
  }
  ...
  return (
    <div className="grid gap-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">View courses you are enrolled in.</p>
      </div>
      ...
      {enrollments.length === 0 ? (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Browse the catalog and enroll in a course to start learning.</CardDescription>
          </CardHeader>
          <CardContent>
